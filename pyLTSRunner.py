...
class pyLTSRunner():
    ...
    #==================================================================================
    def get_validated_json_data(self, filepath_json):
    ...
    def sanity_check_for_netlist(self, netlist):
    ...
    def get_parsed_and_sanity_checked_modif_item(self, str_raw_modif_item):
    ...
    def run_simulations(self, jobDesc):
        ...
        for cnt,modifData in enumerate(jobDesc["LIST_OF_MODIFICATIONS"]):
            ...
            for rawModifItem in modifData["ModifList"]:
                parModIt = self.get_parsed_and_sanity_checked_modif_item(rawModifItem)
            ...
            runner.run(netlist, run_filename=run_netlist_file, callback=self.processing_data)
    ...
    #==================================================================================
    def run_simulation_from_jobfile(self, jobDesc_input):
            # filepath_json = "myJson.json"
        jobDesc = self.get_validated_json_data(jobDesc_input)
        diReturnData = self.run_simulations(jobDesc)
        return diReturnData

    #==================================================================================
    def copy_libfiles_to_ltspice_dir(self, dirSub, dirSym, dirLocalLibFiles):
        try:
